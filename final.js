...
document.getElementById('reveal').addEventListener('click', function() {
    ...
    if (button.textContent === "Reveal Message") {
        message.textContent = "Last but not least, i just wanna to say thank uu for your love and everything u’ve done for me. ur presence in my life has filled it with so much joy and happiness. u’ve stood by me in times of hardship, celebrated with me in times of joy, n hv always been my constant source of support and inspiration. I am incredibly lucky to have u in my life. As we continue this journey together, i look forward to creating more beautiful memories with uu xixi. i love uuu so much. hepi valentine, doain emyu menang pls 😿🙏";
